...
function getUpdateType(currentValue, newValue) {
    ...
    if (semver1.major !== semver2.major) {
        console.log("getUpdateType => major");
        return "major";
    }
    else if (semver1.minor !== semver2.minor) {
        console.log("getUpdateType => minor");
        return "minor";
    }
    else if (semver1.patch !== semver2.patch) {
        console.log("getUpdateType => patch");
        return "patch";
    }
    else {
        console.log("getUpdateType => identical");
        return "identical";
    }
}
exports.getUpdateType = getUpdateType;
//# sourceMappingURL=getUpgradeType.js.map